// step 26: now we can use the same contenct api so let do that 
// step 27: now this is working but we have to change some css of app.scc file give the main tag a min-height property and some fixes like header position to sticky
